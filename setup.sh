...
if [ "$CHANGES_MADE" = true ]; then
    ...
    echo ""
    echo "GitHub workflow commands:"
    echo "  /github-details - Fetch GitHub project config"
    echo "  /write-issue    - Draft issues in .docs/"
    echo "  /create-issue   - Publish issues to GitHub"
    echo "  /create-branch  - Create linked branches"
else
